...
const Detail = () => {
  ...
  function handleOpenWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&&text=Tenho interesse na coleta de resíduos deste ponto`);
  }
  ...
  return (
    <SafeAreaView style = {{flex: 1}}>
      ...
      <View style = {styles.footer}>
        <RectButton style = {styles.button} onPress = {handleOpenWhatsapp}>
